...
$Connection = Get-VpnConnection -Name cloudforce-vnet
if($connection -ne $null)
{
	try
    {
     if ($Force -eq $false) {
	    ...
	    Remove-VpnConnection -Name cloudforce-vnet -Force -ErrorAction Stop
...
try
{
    ...
    {
        Add-VpnConnection -Name cloudforce-vnet -ServerAddress azuregateway-b89b0031-0298-4ee3-807e-1ae3a738ef48-52ff4eb13241.vpn.azure.com -TunnelType Ikev2 -AuthenticationMethod Eap -SplitTunneling:$True -RememberCredential -EncryptionLevel Optional -EapConfigXmlStream $EAP -PassThru
    } else {
        Add-VpnConnection -Name cloudforce-vnet -ServerAddress azuregateway-b89b0031-0298-4ee3-807e-1ae3a738ef48-52ff4eb13241.vpn.azure.com -TunnelType Ikev2 -AuthenticationMethod MachineCertificate -SplitTunneling:$True -RememberCredential -EncryptionLevel Optional -PassThru
    }
}
catch
{
...
Add-VpnConnectionRoute -ConnectionName cloudforce-vnet -DestinationPrefix 10.0.0.0/16
Add-VpnConnectionRoute -ConnectionName cloudforce-vnet -DestinationPrefix 172.16.0.0/24
